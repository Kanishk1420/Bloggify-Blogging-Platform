...
const Footer = () => {
  ...
  return (
    <footer className={`${theme ? "bg-zinc-950" : "bg-black"} w-full mt-auto`}>
      <div className="mx-auto w-full max-w-5xl px-4 py-8 sm:py-12 lg:py-16">
        <div className="flex flex-col items-center">
          <div className="flex justify-center text-teal-600">
            <img src={logo} className='w-16 h-16 md:w-20 md:h-20 rounded-md shadow-gray-500 shadow-2xl backdrop-blur-md' />
          </div>
